...
## Optional publication engine (off by default)
...
| Package | License | Why it is here |
|---|---|---|
| emdash | MIT | The CMS: schema, content API, back office at /_emdash/admin |
| @emdash-cms/cloudflare | MIT | D1 (content) and R2 (media) bindings, Worker entry |
