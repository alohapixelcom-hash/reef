...
// dependance d'emdash, pas du theme : avec l'arborescence stricte de pnpm,
// src/ ne peut pas ecrire `import ... from "@emdash-cms/admin/locales"`.
// moteur.config.mjs resout le chemin reel depuis emdash lui-meme et le pose
// sous ce nom (voir la fonction `alias`). Ce fichier n'en decrit que ce que
// src/moteur/catalogue-bo.ts utilise.
